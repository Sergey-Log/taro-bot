...
def format_reading_advice(cards, spread_id):
    ...
    # ✅ УВЕЛИЧЕННЫЕ СОВЕТЫ ДЛЯ ВСЕХ ТИПОВ РАСКЛАДОВ
    if spread_id in ['celtic_cross', 'past_present_future']:
    ...
    # ✅ УВЕЛИЧЕННЫЕ СОВЕТЫ ДЛЯ РАСКЛАДА НА ОТНОШЕНИЯ
    elif spread_id == 'relationship':
        advice_parts = []
        
        if "Влюблённые" in card_names or "Двойка Кубков" in card_names:
            advice_parts.append("❤️‍🔥 Ваши отношения находятся в гармоничной фазе. Доверяйте своей интуиции и открыто выражайте чувства. Сейчас идеальное время для глубоких разговоров и совместных решений. Не бойтесь быть уязвимым — искренность укрепляет связь.")
        
        if "Повешенный" in card_names or "Отшельник" in card_names:
            advice_parts.append("💫 Возможно, вам нужно время для себя. Не торопите события — дайте отношениям «дозреть». Иногда пауза помогает увидеть ситуацию с новой стороны и понять истинные чувства.")
        
        if "Башня" in card_names or "Смерть" in card_names:
            advice_parts.append("🌙 Отношения проходят через трансформацию. Не цепляйтесь за старые шаблоны — иногда разрушение необходимо для нового уровня близости. Доверяйте процессу и будьте честны с собой и партнёром.")
        
        if "Солнце" in card_names or "Звезда" in card_names:
            advice_parts.append("☀️ Вас ждёт период гармонии и взаимопонимания. Радуйтесь моменту и делитесь своей любовью. Ваша открытость притягивает позитивные события в отношениях.")
        
        if "Дьявол" in card_names or "Пятёрка Мечей" in card_names:
            advice_parts.append("⚠️ Обратите внимание на токсичные паттерны. Возможно, в отношениях есть зависимость или манипуляции. Освободитесь от того, что держит вас в плену — истинная любовь основана на свободе и уважении.")
        
        if not advice_parts:
            advice_parts.append("💫 Отношения — это зеркало вашей души. Доверяйте своей интуиции, будьте честны с собой и партнёром. Помните: вы заслуживаете любви, основанной на взаимном уважении и поддержке.")
        
        result += "\n\n".join(advice_parts)
    
    # ✅ УВЕЛИЧЕННЫЕ СОВЕТЫ ДЛЯ РАСКЛАДА НА КАРЬЕРУ
    elif spread_id == 'career':
        advice_parts = []
        
        if "Маг" in card_names or "Император" in card_names:
            advice_parts.append("💼 Вы обладаете всеми ресурсами для успеха. Действуйте уверенно и используйте свои сильные стороны. Сейчас идеальное время для реализации амбициозных проектов и переговоров.")
        
        if "Колесница" in card_names or "Сила" in card_names:
            advice_parts.append("🚀 Ваша целеустремлённость приведёт к успеху. Не сдавайтесь перед препятствиями — каждое испытание делает вас сильнее. Доверяйте своему пути и действуйте с уверенностью.")
        
        if "Отшельник" in card_names or "Повешенный" in card_names:
            advice_parts.append("💫 Возможно, вам нужно время для анализа. Не торопитесь с решениями — дайте ситуации «дозреть». Иногда пауза помогает увидеть новые возможности и стратегии.")
        
        if "Башня" in card_names or "Смерть" in card_names:
            advice_parts.append("🌙 Карьера проходит через трансформацию. Не бойтесь перемен — иногда разрушение старого открывает путь к лучшему. Доверяйте процессу и будьте открыты новым возможностям.")
        
        if "Солнце" in card_names or "Звезда" in card_names:
            advice_parts.append("☀️ Вас ждёт период профессионального роста и признания. Радуйтесь своим достижениям и делитесь успехом с коллегами. Ваша энергия притягивает новые возможности.")
        
        if "Дьявол" in card_names or "Восьмёрка Пентаклей" in card_names:
            advice_parts.append("⚠️ Обратите внимание на баланс работы и личной жизни. Возможно, вы слишком много времени уделяете карьере в ущерб себе. Найдите гармонию — истинный успех включает все сферы жизни.")
        
        if not advice_parts:
            advice_parts.append("💫 Карьера — это путь самореализации. Доверяйте своим талантам, будьте открыты новому и не бойтесь брать на себя ответственность. Вы способны достичь больших высот!")
